...
from ufldDetector.exportLib.ultrafastLaneV2 import model_tusimple
...
def convert_model(model_path, model_type=LaneModelType.UFLDV2_CULANE):
	...
	if ( "UFLDV2" in model_type.name) :
		cfg = merge_config("./ufldDetector/exportLib/ultrafastLaneV2/configs/"+file.stem+".py")
...
if __name__ == '__main__':
	model_path = "E:\Matlab\Perception1\Deep_Learning\TrafficLaneDetector\models\culane_res18.pth"
